...
function americanPoem(event) {
  ...
  let context="You are a nature expert and love to write four lines of poem about nature. Generate a short poem in basic HTML. Sign the end of the poem with 'SheCodes AI' with a different color than the text.";
